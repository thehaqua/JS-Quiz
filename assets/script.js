var questions = [{
    ...
    question: "9. Inside which HTML element do we put the JavaScript?",
    choices: ["js", "script", "javascript", "scripting"],
    correctAnswer: 1
}, {
    question: "10. Where is the correct place to insert a JavaScript?",
    choices: ["The body section", "Both the head section and the body section are correct", "The head section", "The CSS file"],
    correctAnswer: 1
}];
